...
|  | Testing valid input of y for y/n prompt | User should be shown the main menu | Test successful (capital Y or N also accepted) | ![screenshot](documentation/defensive/vc/wom_dp_vc_valid_y.gif "Valid input of y") |
|  | Testing valid input of n for y/n prompt | User should be shown the app exit message and app ends | Test successful (capital Y or N also accepted) | ![screenshot](documentation/defensive/vc/wom_dp_vc_valid_n.gif "Valid input of n") |
...
|  | Testing valid input of y for y/n prompt | User should be shown the main menu | Test successful (capital Y or N also accepted) | ![screenshot](documentation/defensive/vw/wom_dp_vw_valid_y.gif "Valid input of y") |
|  | Testing valid input of n for y/n prompt | User should be shown the app exit message and app ends | Test successful (capital Y or N also accepted) | ![screenshot](documentation/defensive/vw/wom_dp_vw_valid_n.gif "Valid input of n") |
